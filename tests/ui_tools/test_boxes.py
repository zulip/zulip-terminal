...
class TestWriteBox:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("#**Stream 1>T", -1, True, "#**Stream 1>✔ Topic 1**"),
            ("#**Stream 1>T", -2, True, "#**Stream 1>Hello t/here!**"),
            ("#**Stream 1>T", -3, True, "#**Stream 1>He-llo there!**"),
            ("#**Stream 1>T", -4, True, "#**Stream 1>Hello there!**"),
            ("#**Stream 1>T", -5, True, "#**Stream 1>This is a topic**"),
            ("#**Stream 1>T", -6, True, "#**Stream 1>Topic 1**"),
            ("#**Stream 1>T", -7, True, None),
            ...
            ("#**Stream 1>", -1, True, "#**Stream 1>✔ Topic 1**"),
            ("#**Stream 1>", -2, True, "#**Stream 1>Hello from out-er_space!**"),
            ("#**Stream 1>", -3, True, "#**Stream 1>Hello t/here!**"),
            ("#**Stream 1>", -4, True, "#**Stream 1>He-llo there!**"),
            ("#**Stream 1>", -5, True, "#**Stream 1>Hello there!**"),
