...
class KeyConfig:
    def __init__(self) -> None:
        self.terminology: str = ""  # Default terminology
    ...
    def set_terminology(self, terminology: str) -> None:
        ...
        self.KEY_BINDINGS: Dict[str, KeyBinding] = {
            ...
            "AUTOCOMPLETE": {
                "keys": ["ctrl f"],
                "help_text": (
                    f"Autocomplete @mentions, #{self.terminology}_names, :emoji:"
                    " and topics"
                ),
                "key_category": "compose_box",
            },
            ...
            "TOGGLE_NARROW": {
                "keys": ["z"],
                "help_text": "Zoom in/out the message's conversation context",
                "key_category": "narrowing",
            },
            ...
            "VIEW_IN_BROWSER": {
                "keys": ["v"],
                "help_text": "View current message in browser",
                "excluded_from_random_tips": True,
                "key_category": "msg_info",
            },
            "STREAM_INFO": {
    ...
    def display_key_for_urwid_key(self, urwid_key: str) -> str:
        ...
        for (
            urwid_map_key,
            display_map_key,
        ) in self.URWID_KEY_TO_DISPLAY_KEY_MAPPING.items():
