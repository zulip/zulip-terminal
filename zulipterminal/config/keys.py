...
KEY_BINDINGS: Dict[str, KeyBinding] = {
    ...
    'BEGINNING_OF_LINE': {
        ...
        'key_categories': ['editor_navigation'],
    },
    'END_OF_LINE': {
        'keys': ['ctrl e', 'end'],
    ...
    'UNDO_LAST_ACTION': {
        ...
        'key_categories': ['editor_text_manipulation'],
    },
    'CLEAR_MESSAGE': {
        'keys': ['ctrl l'],
