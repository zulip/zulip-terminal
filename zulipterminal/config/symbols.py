...
SHIFT_KEY = "⇧"  # UPWARDS WHITE ARROW, U+21E7
ENTER_KEY = "⏎"  # RETURN SYMBOL, U+23CE
# Alternative ENTER_KEY: "↵" # DOWNWARDS ARROW WITH CORNER LEFTWARDS, U+21B5
META_KEY = "⌥"  # OPTION KEY, U+2325
# Alternative META_KEY = "⎇"  # ALTERNATIVE KEY SYMBOL, U+2387
CTRL_KEY = "✲"  # OPEN CENTRE ASTERISK, U+2732
# Alternative CTRL_KEY: "⎈" # HELM SYMBOL, U+2388
