...
STYLES = {
    ...
    'unread'          : (Color.LIGHT_GRAY_2,        Color.WHITE),
    ...
    'msg_math'        : (Color.DARK_GRAY_2,         Color.LIGHT_GRAY_2),
    ...
    'msg_quote'       : (Color.BROWN,               Color.WHITE),
    'msg_code'        : (Color.BLACK,               Color.LIGHT_GRAY_2),
    ...
    'muted'           : (Color.LIGHT_GRAY_2,        Color.WHITE),
    'muted_selected'  : (Color.DARK_GRAY,          Color.LIGHT_GRAY),   # override focus style
