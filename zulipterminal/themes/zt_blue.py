...
STYLES = {
    ...
    'selected'        : (Color.BLACK,               Color.DARK_BLUE),
    'msg_selected'    : (Color.BLACK,               Color.DARK_BLUE),
    ...
    'msg_link'        : (Color.DARK_RED,            Color.LIGHT_BLUE),
    'msg_link_index'  : (Color.DARK_RED__BOLD,      Color.LIGHT_BLUE),
    'msg_quote'       : (Color.YELLOW,              Color.LIGHT_BLUE),
    ...
    'muted'           : (Color.LIGHT_CYAN,          Color.LIGHT_BLUE),
    'muted_selected'  : (Color.LIGHT_GRAY,          Color.DARK_BLUE),  # override focus style
