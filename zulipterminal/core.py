...
from zulipterminal.config.themes import popup_styles
...
class Controller:
    ...
    def show_pop_up(self, to_show: Any, popup_type: str) -> None:
        self.loop.widget = urwid.Overlay(
            urwid.AttrMap(urwid.LineBox(
                to_show, to_show.title,
                title_attr=popup_styles[popup_type]['title_attr'],
                **popup_styles[popup_type]['borders']),
            popup_styles[popup_type]['colors']),
            self.view,
            align='center',
            valign='middle',
    ...
    def show_topic_edit_mode(self, button: Any) -> None:
        self.show_pop_up(EditModeView(self, button), 'info')
