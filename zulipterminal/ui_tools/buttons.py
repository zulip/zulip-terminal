...
class HomeButton(TopButton):
    def __init__(self, *, controller: Any, count: int) -> None:
        button_text = (
            f"All messages     [{primary_keyboard_key_for_command('ALL_MESSAGES')}]"
        )
...
class PMButton(TopButton):
    def __init__(self, *, controller: Any, count: int) -> None:
        button_text = f"Direct messages  [{primary_keyboard_key_for_command('ALL_PM')}]"
...
class MentionedButton(TopButton):
    def __init__(self, *, controller: Any, count: int) -> None:
        button_text = (
            f"Mentions         [{primary_keyboard_key_for_command('ALL_MENTIONS')}]"
        )
...
class StarredButton(TopButton):
    def __init__(self, *, controller: Any, count: int) -> None:
        button_text = (
            f"Starred messages [{primary_keyboard_key_for_command('ALL_STARRED')}]"
        )
