...
class MatrixHttpApi:
    ...
    def get_state_event(self, room_id, event_type):
        ...
        """
        return self._send("GET", f"/rooms/{quote(room_id)}/state/{event_type}")
    ...
    def get_room_messages(self, room_id, token, direction, limit=10, to=None):
        ...
        return self._send("GET", f"/rooms/{quote(room_id)}/messages",
    ...
    def get_filter(self, user_id, filter_id):
        return self._send("GET", f"/user/{user_id}/filter/{filter_id}"
                          )

    def create_filter(self, user_id, filter_params):
        return self._send("POST",
                          f"/user/{user_id}/filter",
                          filter_params)
    ...
    def get_room_id(self, room_alias):
        ...
        Returns:
            Wanted room's id.
        """
        content = self._send("GET", f"/directory/room/{quote(room_alias)}")
    ...
    def set_room_alias(self, room_id, room_alias):
        ...
        return self._send("PUT", f"/directory/room/{quote(room_alias)}",
                          content=data)
    ...
    def remove_room_alias(self, room_alias):
        ...
        Raises:
            MatrixRequestError
        """
        return self._send("DELETE", f"/directory/room/{quote(room_alias)}")
    ...
    def get_room_members(self, room_id):
        ...
        """
        return self._send("GET", f"/rooms/{quote(room_id)}/members")
    ...
    def send_to_device(self, event_type, messages, txn_id=None):
        ...
        return self._send(
            "PUT",
            f"/sendToDevice/{event_type}/{txn_id}",
