...
def escape(ident: str) -> str:
    ...
    if length == 1 and start_dash:
        ...
        for index, c in enumerate(ident):
            ...
            if codepoint == 0x00:
                string.append('\ufffd')
            elif (0x01 <= codepoint <= 0x1F) or codepoint == 0x7F or (index == 0 or (start_dash and index == 1)) and (0x30 <= codepoint <= 0x39):
...
class _Selector:
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.tag = kwargs.get('tag')  # type: ct.SelectorTag | None
        ...
        self.rel_type = kwargs.get('rel_type')  # type: str | None
